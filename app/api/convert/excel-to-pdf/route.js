// app/api/convert/excel-to-pdf/route.js
...
export async function POST(request) {
  try {
    ...
    if (!fileName.endsWith('.xlsx') && !fileName.endsWith('.xls')) {
      return Response.json({ error: 'Please upload a .xlsx or .xls file' }, { status: 400 });
    }
    ...
    const backendResponse = await fetch(`${backendUrl}/convert/excel-to-pdf`, {
      method:  'POST',
