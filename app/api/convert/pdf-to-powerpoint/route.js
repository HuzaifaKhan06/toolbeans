// app/api/convert/pdf-to-powerpoint/route.js
...
export async function POST(request) {
  try {
    ...
    const backendResponse = await fetch(`${backendUrl}/convert/pdf-to-powerpoint`, {
      method:  'POST',
    ...
    const downloadName = `TOOLBeans-${originalName}.pptx`;
    ...
    console.error('pdf-to-powerpoint API error:', err);
