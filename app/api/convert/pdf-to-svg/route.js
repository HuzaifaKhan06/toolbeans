// app/api/convert/pdf-to-svg/route.js
...
export async function POST(request) {
  try {
    ...
    const backendResponse = await fetch(`${backendUrl}/convert/pdf-to-svg`, {
      method:  'POST',
    ...
    const downloadName = `TOOLBeans-${originalName}.svg`;
    ...
    console.error('pdf-to-svg API error:', err);
