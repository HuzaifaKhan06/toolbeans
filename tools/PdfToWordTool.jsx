...
export default function PdfToWordTool() {
  ...
  const convert = async () => {
    ...
    try {
      ...
      a.href = url; a.download = `TOOLBeans-${file.name.replace('.pdf', '')}.docx`; a.click();
    ...
    <div className="min-h-screen bg-white">
      <section className="bg-gradient-to-br from-red-50 via-white to-orange-50 border-b border-slate-100 py-12">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <nav className="flex items-center justify-center gap-2 text-xs text-slate-400 mb-5">
            ...
            <span className="text-slate-600 font-semibold">PDF to Word</span>
          </nav>
          <div className="flex flex-wrap items-center justify-center gap-2 mb-5">
            {['Free','No Data Stored','LibreOffice Quality','.docx Output'].map(b => (
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-3">
            PDF to <span className="bg-gradient-to-r from-red-500 to-orange-500 bg-clip-text text-transparent">Word Converter</span>
          </h1>
          <p className="text-base text-slate-500 font-light max-w-xl mx-auto leading-relaxed">
            Convert PDF files to editable Word .docx documents. Text, headings and tables extracted accurately. Powered by LibreOffice on our secure server.
          </p>
          <div className="flex flex-wrap justify-center gap-8 mt-7">
            {[{v:'PDF',l:'Input'},{v:'.docx',l:'Output'},{v:'50 MB',l:'Max Size'},{v:'Editable',l:'Word Doc'}].map(s => (
      ...
      <section className="max-w-3xl mx-auto px-6 py-10">
            ...
            {status === 'done' && (
              <div className="flex flex-col gap-3">
                <div className="bg-green-50 border border-green-200 rounded-2xl p-5 text-center">
                  ...
                  <p className="font-bold text-green-800 mb-1">Word Document Downloaded!</p>
                  <p className="text-sm text-green-600">Saved as <strong>TOOLBeans-{file.name.replace('.pdf', '')}.docx</strong></p>
                </div>
        ...
        <div className="mt-8 bg-amber-50 border border-amber-200 rounded-2xl p-5">
          <p className="text-xs font-bold text-amber-700 uppercase tracking-wider mb-2">⚠️ About PDF to Word Quality</p>
          <p className="text-xs text-slate-600 leading-relaxed">
            PDF to Word conversion quality depends on the source PDF. Text-based PDFs convert well with headings, paragraphs and tables preserved. Scanned PDFs (image-based) will produce a document with limited editable text. Complex layouts with columns or floating text boxes may need manual adjustment.
          </p>
        </div>
      </section>
        {/* ADD 
      ...
      */}
      ...
      <section className="max-w-4xl mx-auto px-6 pb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            {n:'2',icon:'⚙️',t:'TOOLBeans Converts',d:'Your file is sent to our secure server where LibreOffice converts it to an editable Word document.'},
            {n:'3',icon:'⬇️',t:'.docx Downloads',  d:'Your Word document downloads automatically. The file is deleted from our server immediately.'},
          ].map(s => (
      ...
      <section className="max-w-4xl mx-auto px-6 pb-16">
        <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
          <h2 className="text-xl font-extrabold text-slate-900 mb-4">Free PDF to Word Converter — Editable .docx Output</h2>
          <p className="text-sm text-slate-500 leading-relaxed mb-4">
            TOOLBeans PDF to Word converter uses LibreOffice on a secure server to convert PDF files to editable .docx documents. The converted file opens in Microsoft Word, Google Docs and LibreOffice Writer.
          </p>
          <p className="text-sm text-slate-500 leading-relaxed">
            Your file is uploaded securely over HTTPS, converted immediately and deleted right after your .docx downloads. For other conversions see{' '}
            <Link href="/tools/word-to-pdf"       className="text-red-500 hover:underline">Word to PDF</Link>,{' '}
            <Link href="/tools/pdf-to-excel"      className="text-red-500 hover:underline">PDF to Excel</Link> and{' '}
